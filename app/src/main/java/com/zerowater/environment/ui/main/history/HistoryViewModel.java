...
/**
 * Created by YoungSoo Kim on 2019-10-15.
 * Zero Ltd
 * byzerowater@gmail.com
 * HistoryViewModel
 */
public class HistoryViewModel extends BaseViewModel<List<String>> {
     ...
     */
    @Inject
    public HistoryViewModel(DataManager dataManager, ErrorMessageManager errorMessageManager) {
