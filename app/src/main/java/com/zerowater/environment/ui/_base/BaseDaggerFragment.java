 ...
 * 기본 상속형 DaggerFragment
 */
public abstract class BaseDaggerFragment<VDB extends ViewDataBinding, VM extends BaseViewModel> extends DaggerFragment {
                            ...
                            public void onNegativeClick(Dialog dialog) {
                                ...
                                switch (type) {
                                    ...
                                    case UNAUTHORIZED:
                                        ...
                                        NavHostFragment.findNavController(BaseDaggerFragment.this).navigate(NavGraphDirections.actionSplash());
                                        break;
                                    case SERVER:
                                    case APP:
                                        retryProcessor.onError(retryResource.getThrowable());
